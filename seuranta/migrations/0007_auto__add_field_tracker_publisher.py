...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tracker.publisher'
        db.add_column(u'seuranta_tracker', 'publisher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='trackers', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tracker.publisher'
        db.delete_column(u'seuranta_tracker', 'publisher_id')
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'MPTX9WRoQA2ePz6e2i0O3A'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            'Meta': {'ordering': "['competition', 'start_time', 'name']", 'object_name': 'Competitor'},
            '_utc_start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 15, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'WDFt6g_tTEKS8N1e3Zx0Jw'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'kYDzDDjVT6mTkKBUixAQ4A'", 'unique': 'True', 'max_length': '36'})
        }
    }
