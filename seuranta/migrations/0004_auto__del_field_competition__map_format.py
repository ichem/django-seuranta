...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'_tFQzbmiSHibPWdJwaSogQ'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'uzroEeBmQHOFM3eVPBJzEw'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dZJh9wEkQu6nIPdOrEVErg'", 'unique': 'True', 'max_length': '36'})
        }
    }
