...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competitor._utc_start_time'
        db.add_column(u'seuranta_competitor', '_utc_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competitor._utc_start_time'
        db.delete_column(u'seuranta_competitor', '_utc_start_time')
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'NnFK60O7Tf-omfDq_eGx8A'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            'Meta': {'ordering': "['competition', 'start_time', 'name']", 'object_name': 'Competitor'},
            '_utc_start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2Q2K1U0US0uXq6wiGt75TQ'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'eJK1dBhpTE67Hvvg_cA1wQ'", 'unique': 'True', 'max_length': '36'})
        }
    }
