...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competitor.approved'
        db.add_column(u'seuranta_competitor', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Competition.inscription_policy'
        db.add_column(u'seuranta_competition', 'inscription_policy',
                      self.gf('django.db.models.fields.CharField')(default='intern', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competitor.approved'
        db.delete_column(u'seuranta_competitor', 'approved')

        # Deleting field 'Competition.inscription_policy'
        db.delete_column(u'seuranta_competition', 'inscription_policy')
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 22, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'SWm_KnsIRm6ierChuwLbpQ'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            'Meta': {'ordering': "['competition', 'start_time', 'name']", 'object_name': 'Competitor'},
            '_utc_start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 22, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'joR93uM1RwKYly-QM7TyCA'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'utck2yN4Q6CTK7-jt54THQ'", 'unique': 'True', 'max_length': '36'})
        }
    }
