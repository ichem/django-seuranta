...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.calibration_string'
        db.alter_column(u'seuranta_competition', 'calibration_string', self.gf('django.db.models.fields.CharField')(default='_', max_length=255))

    def backwards(self, orm):

        # Changing field 'Competition.calibration_string'
        db.alter_column(u'seuranta_competition', 'calibration_string', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'vrtCfgjsQFOzrNSYcGLKkA'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'NRfC79IOQwik_yJUWzytCQ'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'82QZJIG4R6KwRJJlydCYXg'", 'unique': 'True', 'max_length': '36'})
        }
    }
