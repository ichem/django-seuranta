...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.last_update'
        db.add_column(u'seuranta_competition', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 7, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.last_update'
        db.delete_column(u'seuranta_competition', 'last_update')
    ...
    models = {
        ...
        u'seuranta.competition': {
            ...
            'end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 8, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'iqjcpC0mQcmvrlD-uIpc_w'", 'unique': 'True', 'max_length': '36'})
        },
        u'seuranta.competitor': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'LHlQeGhJRz2CzPehmzE70Q'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        u'seuranta.tracker': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'nCHpRYVNR-aaJktNuOl6QQ'", 'unique': 'True', 'max_length': '36'})
        }
    }
